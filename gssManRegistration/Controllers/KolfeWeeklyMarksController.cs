...
{
    public class KolfeWeeklyMarksController : ApiController
    {
        private readonly kolfeMarkDbContext dbContext = new kolfeMarkDbContext();

        // GET: api/kolfeweeklymarks
        public IQueryable<weeklymarks20212022> GetWeeklyMarks()
        {
            return dbContext.weeklymarks20212022;
        }

        // GET: api/kolfeweeklymarks/5    
