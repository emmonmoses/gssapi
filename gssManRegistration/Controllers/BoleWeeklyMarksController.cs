...
{
    public class BoleWeeklyMarksController : ApiController
    {
        private readonly boleMarkDbContext dbContext = new boleMarkDbContext();

        // GET: api/boleweeklymarks
        public IQueryable<weeklymarks20212022> GetWeeklyMarks()
        {
            return dbContext.weeklymarks20212022;
        }

        // GET: api/boleweeklymarks/5    
