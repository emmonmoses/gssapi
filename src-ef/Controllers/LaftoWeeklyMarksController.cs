...
{
    public class LaftoWeeklyMarksController : ApiController
    {
        private readonly laftoMarkDbContext dbContext = new laftoMarkDbContext();

        // GET: api/laftoweeklymarks
        public IQueryable<weeklymarks20212022> GetTestMarks()
        {
            return dbContext.weeklymarks20212022;
        }

        // GET: api/laftoweeklymarks/5    
        ...
        // POST: api/laftoweeklymarks    
        [ResponseType(typeof(weeklymarks20212022))]
        public IHttpActionResult PostTestMark(weeklymarks20212022 marks)
        {
        ...
        // PUT: api/laftoweeklymarks/5    
        [ResponseType(typeof(void))]
        public IHttpActionResult PutTestMark(int id, weeklymarks20212022 marks)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
