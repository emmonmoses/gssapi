...
namespace gssManRegistration.Controllers
{
    public class SarbetWeeklyMarksController : ApiController
    {
        ...
        // DELETE: api/sarbetweeklymarks/5    
        [ResponseType(typeof(weeklymarks20212022))]
