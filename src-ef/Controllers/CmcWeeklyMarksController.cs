...
{
    public class CmcWeeklyMarksController : ApiController
    {
        private readonly cmcMarkDbContext dbContext = new cmcMarkDbContext();

        // GET: api/cmcweeklymarks
        public IQueryable<weeklymarks20212022> GetWeeklyMarks()
        {
            return dbContext.weeklymarks20212022;
        }

        // GET: api/cmcweeklymarks/5    
