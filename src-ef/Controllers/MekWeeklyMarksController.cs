...
{
    public class MekWeeklyMarksController : ApiController
    {
        private readonly mekMarkDbContext dbContext = new mekMarkDbContext();

        // GET: api/mekweeklymarks
        public IQueryable<weeklymarks20212022> GetWeeklyMarks()
        {
            return dbContext.weeklymarks20212022;
        }

        // GET: api/mekweeklymarks/5    
